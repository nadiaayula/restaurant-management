...
import { useAccountListQuery, useDeleteEmployeeAccountMutation } from '@/queries/useAccount'
...
function AlertDialogDeleteAccount({
  ...
  const deleteEmployeeAccountMutation = useDeleteEmployeeAccountMutation()

  const deleteAccount = async () => {
    if (employeeDelete) {
      try {
        const result = await deleteEmployeeAccountMutation.mutateAsync(employeeDelete.id)
...
export default function AccountTable() {
  ...
  const accountList = useAccountListQuery()
